...
/**
 * Clase Query - Manejo avanzado de consultas SQL
 * 
 * Esta clase proporciona una interfaz fluida para construir y ejecutar consultas SQL
 * utilizando PDO, permitiendo realizar operaciones como SELECT, INSERT, UPDATE y DELETE
 * con facilidad.
 */
class Query extends Db {

    // Propiedades principales de la consulta
    protected $table;          // Nombre de la tabla
    protected $pdo;            // Instancia de conexión PDO
    protected $defaultColumns = '*'; // Columnas por defecto
    protected $where = [];     // Condiciones WHERE
    protected $joins = [];     // JOINs SQL
    protected $orderBy = [];   // Ordenamientos ORDER BY
    protected $groupBy = [];   // Agrupaciones GROUP BY
    protected $having = [];    // Condiciones HAVING
    protected $limit = '';     // Límite de resultados
    protected $distinct = false;  // Bandera para SELECT DISTINCT
    protected $selectColumns = []; // Columnas a seleccionar
    protected $bindings = [];  // Parámetros a enlazar en la consulta 
