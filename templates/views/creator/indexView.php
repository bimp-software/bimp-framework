    ...
    <main>
        <div class="container py-5 main-wrapper">
            <div class="text-center mb-5">
                ...
                <p class="lead">Este módulo facilita la creación automática de vistas, modelos y controladores, asegurando una estructura organizada y eficiente dentro del framework MVC.</p>
            </div>
